	...
	<div class="container p-3 my-3 rounded"
		...
		<div>
			<form:form action="/catchrecords/${catchRecord.id}/method"
				...
				<button class="btn rounded" style="background-color: #fe9929">Update</button>
			</form:form>
		</div>
		<div class="d-flex my-3">
			<form class="btn rounded" style="background-color: #cc4c02" action="/catchrecords/{id}/method" method="post">
				<input class="btn" style="background-color: #cc4c02" type="hidden" name="_method" value="delete"> <input
